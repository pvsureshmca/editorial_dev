		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>news_paper/edit/<?php echo $this->uri->segment(3); ?>/"><?php echo NEWS_EDIT;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<?php } ?>
							<form class="cmxform form-horizontal " id="news_paper_add"
								method="post" action="<?php echo base_url();?>news_paper/edit/<?php echo $this->uri->segment(3); ?>/" novalidate="novalidate" enctype="multipart/form-data">
