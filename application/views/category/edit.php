		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>category/edit/<?php echo $this->uri->segment(3); ?>/"><?php echo CAT_EDIT;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<?php } ?>
							<form class="cmxform form-horizontal " id="category_add"
								method="post" action="<?php echo base_url();?>category/edit/<?php echo $this->uri->segment(3); ?>/" novalidate="novalidate" enctype="multipart/form-data">
