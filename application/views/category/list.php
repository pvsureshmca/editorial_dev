		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>category/"><?php echo CAT_PAGE;?></a>
					</li>
				</ul>
			</div>
		</div>
					...
					<header class="panel-heading">
                        ...
                        <span class="tools pull-right">
							<button class="btn btn-primary"
								onclick="location.href ='<?php echo base_url(); ?>category/add'">Add</button>
							  ...
							  <?php
                                ...
                                <tr>
											...
											<td class=""><a class="btn mini purple"
												href="<?php echo base_url(); ?>category/edit/<?php echo md5($details['id']); ?>/"><i
													class="fa fa-pencil" title="Edit"></i></a> <a class="btn mini purple"
												href="<?php echo base_url(); ?>category/delete/<?php echo md5($details['id']); ?>/"
