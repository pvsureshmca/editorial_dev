		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a href="<?php echo base_url();?>tags/"><?php echo TAGS_PAGE;?></a>
					</li>
					<li><a class="current" href="<?php echo base_url();?>tags/edit/<?php echo $this->uri->segment(3); ?>/"><?php echo TAGS_EDIT;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<?php } ?>
							<form class="cmxform form-horizontal " id="tags_add"
								method="post" action="<?php echo base_url();?>tags/edit/<?php echo $this->uri->segment(3); ?>/" novalidate="novalidate" enctype="multipart/form-data">
