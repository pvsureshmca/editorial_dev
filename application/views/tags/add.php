		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>tags/add"><?php echo TAGS_ADD;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<?php } ?>
							<form class="cmxform form-horizontal " id="tags_add"
								method="post" action="<?php echo base_url();?>tags/add" novalidate="novalidate" enctype="multipart/form-data">
