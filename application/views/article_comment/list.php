		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>article_comment/"><?php echo ARTCMD_PAGE;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="row">
			<div class="col-sm-12">
				<section class="panel">
					<header class="panel-heading">
                        <?php echo ARTCMD_LIST;?>
                        <span class="tools pull-right">
							<button class="btn btn-primary"
								onclick="location.href ='<?php echo base_url(); ?>article_comment/add'">Add</button>
							...
							<div id="dynamic-table_wrapper"
									...
									<thead>
										<tr role="row">
											<th class="sorting" role="columnheader" tabindex="0"
												...
												style="width: 80px;">S.NO</th>
											<th class="sorting" role="columnheader" tabindex="0"
												aria-controls="dynamic-table" rowspan="1" colspan="1"
												aria-label="Browser: activate to sort column ascending"
												style="width: 150px;">Article</th>	
											<th class="sorting" role="columnheader" tabindex="0"
												aria-controls="dynamic-table" rowspan="1" colspan="1"
												aria-label="Browser: activate to sort column ascending"
												style="width: 550px;">Description</th>	
							  ...
							  <?php
                                ...
                                <tr>
											...
											<td class=""><?php echo $details['article']; ?></td>
											<td class="">
 ...
 <?php echo $details['description']; ?>
											...
											<td class=""><a class="btn mini purple"
												href="<?php echo base_url(); ?>article_comment/edit/<?php echo md5($details['id']); ?>/"><i
													class="fa fa-pencil" title="Edit"></i></a> <a class="btn mini purple"
												href="<?php echo base_url(); ?>article_comment/delete/<?php echo md5($details['id']); ?>/"
