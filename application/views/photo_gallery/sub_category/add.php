		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>photo_gallery/sub_category/add"><?php echo SUBCAT_ADD;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<?php } ?>
							<form class="cmxform form-horizontal " id="sub_category_add"
								method="post" action="<?php echo base_url();?>photo_gallery/sub_category/add" novalidate="novalidate" enctype="multipart/form-data">
