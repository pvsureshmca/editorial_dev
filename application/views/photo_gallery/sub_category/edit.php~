		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a href="<?php echo base_url();?>photo_gallery/sub_category/"><?php echo SUBCAT_PAGE;?></a>
					</li>
					<li><a class="current" href="<?php echo base_url();?>photo_gallery/sub_category/edit/<?php echo $this->uri->segment(4); ?>/"><?php echo SUBCAT_EDIT;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<?php } ?>
							<form class="cmxform form-horizontal " id="sub_category_add"
								method="post" action="<?php echo base_url();?>photo_gallery/sub_category/edit/<?php echo $this->uri->segment(4); ?>/" novalidate="novalidate" enctype="multipart/form-data">
