		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>photo_gallery/category/add"><?php echo CAT_ADD;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<?php } ?>
							<form class="cmxform form-horizontal " id="category_add"
								method="post" action="<?php echo base_url();?>photo_gallery/category/add" novalidate="novalidate" enctype="multipart/form-data">
