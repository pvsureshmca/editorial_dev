		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>photo_gallery/sub_two_category/"><?php echo SUBTWOCAT_PAGE;?></a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="col-sm-12">
				<section class="panel">
					<header class="panel-heading">
                        <?php echo SUBTWOCAT_LIST;?>
                        <span class="tools pull-right">
							<button class="btn btn-primary"
								onclick="location.href ='<?php echo base_url(); ?>photo_gallery/sub_two_category/add'">Add</button>
									...
									<thead>
										<tr role="row">
											...
											<th class="sorting" role="columnheader" tabindex="0"
												...
												aria-controls="dynamic-table" rowspan="1" colspan="1"
												aria-label="Browser: activate to sort column ascending"
												style="width: 150px;">Sub Category</th>
...
<td class=""><?php echo $details['sub_category']; ?></td>
											...
											<td class=""><a class="btn mini purple"
												href="<?php echo base_url(); ?>photo_gallery/sub_two_category/edit/<?php echo md5($details['id']); ?>/"><i
													class="fa fa-pencil" title="Edit"></i></a> <a class="btn mini purple"
												href="<?php echo base_url(); ?>photo_gallery/sub_two_category/delete/<?php echo md5($details['id']); ?>/"
