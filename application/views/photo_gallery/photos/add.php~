		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>photo_gallery/photos/add"><?php echo PHOTOS_ADD;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<?php } ?>
							<form class="cmxform form-horizontal " id="photos_add"
								method="post" action="<?php echo base_url();?>photo_gallery/photos/add" novalidate="novalidate" enctype="multipart/form-data">
...
<div class="form-group ">
									...
									<div class="col-lg-8">
										<input class=" form-control" id="event" name="event"
										 value="<?php echo set_value('event');?>" type="text">
									</div>
								</div>
...
<div class="form-group ">
									...
									<div class="col-lg-8">
                                                                       ...
                                                                       <textarea class="form-control" id="description" name="description" rows="5"><?php echo trim($description);?></textarea>
