		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>photo_gallery/tags/"><?php echo TAGS_PAGE;?></a>
					</li>
				</ul>
			</div>
		</div>
					...
					<header class="panel-heading">
                        ...
                        <span class="tools pull-right">
							<button class="btn btn-primary"
								onclick="location.href ='<?php echo base_url(); ?>photo_gallery/tags/add'">Add</button>
									...
									<thead>
										 <tr role="row">
                                            <th class="sorting" role="columnheader" tabindex="0"
                                                aria-controls="dynamic-table" rowspan="1" colspan="1" aria-sort="ascending"
							  ...
							  <?php
                                ...
                                <tr>
											...
											<td class=""><a class="btn mini purple"
												href="<?php echo base_url(); ?>photo_gallery/tags/edit/<?php echo md5($details['id']); ?>/"><i
													class="fa fa-pencil" title="Edit"></i></a> <a class="btn mini purple"
												href="<?php echo base_url(); ?>photo_gallery/tags/delete/<?php echo md5($details['id']); ?>/"
