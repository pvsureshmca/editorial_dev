		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>bookmark/add"><?php echo BOOKMARK_ADD;?></a>
					</li>
				</ul>
			</div>
		</div>
...
<?php } ?>
							<form class="cmxform form-horizontal " id="bookmark_add"
								method="post" action="<?php echo base_url();?>bookmark/add" novalidate="novalidate" enctype="multipart/form-data">
...
<div class="form-group ">
									...
									<div class="col-lg-8">
										<input class=" form-control" id="url" name="url"
										 value="<?php echo set_value('url');?>" type="text">
									</div>
								</div>
