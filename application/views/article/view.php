            ...
            <section class="panel">
                <header class="panel-heading tab-bg-dark-navy-blue ">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a data-toggle="tab" href="#paper"><b>Paper Summary</b></a>
                        </li>
                        <li class="">
                            <a data-toggle="tab" href="#web"><b>Web Summary</b></a>
                        </li>
                        <li class="">
                            <a data-toggle="tab" href="#mobile"><b>Mobile Summary</b></a>
                        </li>
                         <li class="">
                            <a data-toggle="tab" href="#paper1"><b>Paper Description</b></a>
                        </li>
                        <li class="">
                            <a data-toggle="tab" href="#web1"><b>Web Description</b></a>
                        </li>
                        <li class="">
                            <a data-toggle="tab" href="#mobile1"><b>Mobile Description</b></a>
                        </li>
...
<div id="mobile" class="tab-pane">
 ...
 <div id="paper1" class="tab-pane">
		...
		<div class="col-lg-12"> <h5><b>Mobile Description</b> </h5> </div>
  		<div class="col-lg-12"><p><?php echo trim($details['mobile_description']);?></p></div>
                        </div>
			...
			<?php if(sizeof($comment_set)>0){
			foreach ($comment_set as $comment) { ?>
                           <blockquote>
                                    <p>
			 <?php echo trim($comment['description']); ?>
                        </p>  <small> Post By : <cite title="Source Title"> <?php echo trim($comment['user_name']); ?></cite></small>
                                </blockquote>
			<?php }} ?>
