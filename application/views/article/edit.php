		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li><a class="current" href="<?php echo base_url();?>article/edit/<?php echo $this->uri->segment(3); ?>/"><?php echo ARTICLE_EDIT;?></a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading">
                            <?php echo ARTICLE_EDIT;?>
                            <span class="tools pull-right"> <button class="btn btn-primary"
								onclick="location.href ='<?php echo base_url();?>article/view/<?php echo $this->uri->segment(3); ?>/'">View</button></span>
					</header>
...
<div class="form-group ">
									...
									<div class="col-lg-8">
										...
										<?php if(sizeof($layout_list)>0){	foreach ( $layout_list as $layout ) {?>
											<option value="<?php echo $layout['id']; ?>"  <?php if($details['layout_id']==$layout['id']){?> selected="selected" <?php }?>><?php echo $layout['name']; ?></option>
                                        <?php } }?>
 ...
 <?php if($details['page_id']==$page['id']){?> selected="selected" <?php }?>><?php echo $page['name']; ?></option>
                                        <?php } }?>
...
<div class="col-lg-4">
			...
			<select  class="form-control" style="width: 100%"  onChange="GoToSetValues('paper_summary',this.value)" >

			<option value="">Replace latest  version</option>
			<?php if(sizeof($article_version)>0){
                         $i = '0';	
                         foreach ( $article_version as $version ) { $i += 1; ?>
                          <option value="<?php echo $version['id']; ?>" > latest version <?php echo $i; ?></option>
                                        <?php } }?>
...
<textarea class="form-control" id="paper_summary" name="paper_summary" rows="15">
									<?php echo trim($details['paper_summary']);?></textarea>
...
<div class="col-lg-4">
			...
			<select  class="form-control" style="width: 100%"  onChange="GoToSetValues('web_summary',this.value)" >
...
<textarea class="form-control" id="web_summary" name="web_summary" rows="15">
									<?php echo trim($details['web_summary']);?></textarea>
...
<div class="col-lg-4">
			...
			<select  class="form-control" style="width: 100%"  onChange="GoToSetValues('mobile_summary',this.value)" >
...
<textarea class="form-control" id="mobile_summary" name="mobile_summary" rows="15">
									<?php echo trim($details['mobile_summary']);?></textarea>
...
<div class="col-lg-4">
			...
			<select  class="form-control" style="width: 100%"  onChange="GoToSetValues('paper_description',this.value)" >
...
<textarea class="form-control" id="paper_description" name="paper_description" rows="15">
									<?php echo trim($details['paper_description']);?></textarea>
...
<div class="col-lg-4">
			...
			<select  class="form-control" style="width: 100%"  onChange="GoToSetValues('web_description',this.value)" >
...
<textarea class="form-control" id="web_description" name="web_description" rows="15">
									<?php echo trim($details['web_description']);?></textarea>
...
<div class="col-lg-4">
			...
			<select  class="form-control" style="width: 100%"  onChange="GoToSetValues('mobile_description',this.value)" >
...
<textarea class="form-control" id="mobile_description" name="mobile_description" rows="15">
									<?php echo trim($details['mobile_description']);?></textarea>
...
<input  id="status" name="status" value="2" <?php if($details['status']=="2"){ ?> checked="checked" <?php } ?> type="radio"> Filed &nbsp;&nbsp;
<input  id="status" name="status" value="3" <?php if($details['status']=="3"){ ?> checked="checked" <?php } ?> type="radio"> Paged
									</div>
								</div>
